...
class UserTest < ActiveSupport::TestCase
  ...
  test 'name shouldn\'t exceed 50 chars' do
    @user.name = ('a') * 51
    assert_not @user.valid?
  end

  test 'email should\'nt exceed 255 chars' do
    ending = '@gmail.com'
    @user.email = ('a' * (256-ending.length)) + ending
    assert_not @user.valid?
  end
  ...
  test "email address uniqueness should be case insensitive" do
    duplicate = @user.dup
